...
def main(
    ...
    try:
        ...
        bot = Booking(driver, booker_info)
...
### Currently, select_time_slot() will loop all timeslot then show error because the payment() separated
### Need to rebuild the logic of select_time_slot() and payment()